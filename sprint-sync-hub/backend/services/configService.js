...
const CONFIG_DEFS = {
  ...
  'schedule.brief_time':       { category: 'schedule', label: 'Daily Brief Time (HH:MM)', isSecret: false, envVar: 'BRIEF_TIME', default: '09:00' },
...
function getSprintConfig() {
  ...
  return {
    ...
    briefTime:      getSync('schedule.brief_time')     || '09:00',
